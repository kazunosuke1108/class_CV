...
# Input 4 points which is equal to the edge of the building
pts1 = np.float32([[1560, 1728], [2304, 1500], [1616, 2760], [2400, 2808]])
# Define 4 points which the points I mentioned above goes to.
pts2 = np.float32([[500, 500], [2500, 500], [500, 3500], [2500, 3500]])
# Generate the matrix of projective transformation
M = cv2.getPerspectiveTransform(pts1, pts2)
print(M)  # Show the matrix used for the transformation
dst = cv2.warpPerspective(img, M, (3000, 4000))  # Execute the transformation
cv2.imwrite("exercise0425/IMG_7678_after.jpg", dst)
